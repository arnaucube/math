    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item ProtoGalaxy: linear combinations of $\mathbb{F}$ and $\mathbb{G}$ elements with the Lagrange basis and some polynomial evaluations + ... (alternatively SumCheck)
        \end{itemize}
      \end{itemize}
    \end{itemize}
...
\begin{frame}{Original Nova Decider}
  \begin{itemize}
    \item Original Nova: wrap these checks in 2 Spartan (zkSNARK) proofs (one over each curve of the cycle of curves).\\
      $\longrightarrow$ 2 Spartan proofs, one on each curve\\
