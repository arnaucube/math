...
\begin{frame}{Why Lattices?}
  \begin{itemize}
    ...
    \begin{itemize}
      \item LLL (Lenstra–Lenstra–Lovász): polynomial time method used for lattice basis reduction, which transforms a given basis of a lattice into a new basis that is shorter and nearly orthogonal
    \end{itemize}
