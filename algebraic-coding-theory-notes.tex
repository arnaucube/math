...
\begin{thm}{6.12}[Shanon's theorem]
  channel binary symmetric with symbol error probabiliy $p$.
...
\begin{eg}{6.15}
  ...
  $$P_{undetec}(C) = \underbrace{1}_{0101} \cdot p^2 (1-p)^2 + \underbrace{2}_{1011, 1110} \cdot p^3(1-p)^{4-3=1}= p^2 -p^4$$
\end{eg}
